...
<body>
<nav class="navbar navbar-expand-lg navbar-light bg-info fixed-top" style="width: 100%;">
  <div class="container">
    <a class="navbar-brand fw-bold" style="font-weight:700; font-size:30px;" href="#">
    ...
    <div class="collapse navbar-collapse" id="animeNavbar">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0  ">
        <li class="nav-item"><a class="nav-link text-dark" style="font-weight:700; font-size:18px;" href="#">Home</a></li>
        <li class="nav-item"><a class="nav-link text-dark" style="font-weight:700; font-size:18px;" href="#About">About</a></li>
        <li class="nav-item"><a class="nav-link text-dark" style="font-weight:700; font-size:18px;" href="#Blogs">Blogs</a></li>
        <?php if(isset($_SESSION["id"])): ?>
        <li class="nav-item"><a class="nav-link text-dark" style="font-weight:700; font-size:18px;" href="./index.php">Create a Blog</a></li>
        <li class="nav-item"><a class="nav-link text-danger" style="font-weight:700; font-size:18px;" href="./backend/logout.php">Logout</a></li>
        <?php else: ?>
        <li class="nav-item"><a class="nav-link text-dark" style="font-weight:700; font-size:18px;" href="./login.php">Login</a></li>
        <?php endif; ?>
      </ul>
    </div>
  </div>
...
<a href="https://lokeshreddyyama.github.io/Portfolio1/" class="btn1" style="margin-right:10px;">Read More</a>
 ...
 <a href="#" aria-label="GitHub" target="_blank" rel="noopener"><i class="fab fa-github"></i></a>
<a href="https://www.linkedin.com/in/lokesh-reddy-yama-88863831a/" aria-label="LinkedIn" target="_blank" rel="noopener"><i class="fab fa-linkedin"></i></a>
 <a href="https://www.hackerrank.com/profile/yamalokeshreddy1" aria-label="hackerrank"><i class="fa-brands fa-hackerrank"></i></a>
</div>
</div>
</div>
<!--Blogs Section-->
...
$original_date = new DateTime($row['createdat']);
 ...
 echo "
        <div class='col'id='Blogs'>
          <div class='card border-info h-100' style='background-color: rgb(7, 7, 42); border: 1px solid;'>
            ...
            <div class='card-body d-flex flex-column'>
              ...
              <div class='mt-auto'>
                ...
                <a href='./blog.php?id=" . $row['id'] . "' class='btn btn-info mt-2 w-100'>Read More</a>
              </div>
            </div>
          </div>
        </div>
...
<!-- Include Bootstrap JS bundle for collapse functionality -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js"></script>


<!-- Add Bootstrap JS Bundle for collapse to work -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js"></script>
