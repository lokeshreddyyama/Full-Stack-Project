...
<body>
<div class="container-fluid text-center text-light lokesh" style="width: 100%;background-color: rgb(3, 3, 42);">
<h1 class="mb-4 text-warning"><?= htmlspecialchars($blog['title']) ?></h1>
<img src="./db-images/<?= htmlspecialchars($blog['image']) ?>" alt="Blog Image" class="img-fluid mb-4" style="max-height: 400px; object-fit: cover;">
...
<a href="./index1.php" class="btn btn-info mt-5">Back to Blogs</a>
</div>
<footer class="bg-black text-light pt-5 pb-3" style="width:100%; left:0; right:0;padding:0 80px;">
  <div class="container-fluid px-0 mx-0" style="max-width:100vw;">
    <div class="row text-center text-md-start ">
      ...
      <h4 class="text-warning">Anime Cards</h4>
        <p class="small">
          Explore the world of anime through beautifully crafted cards.
          From iconic characters to legendary stories, we bring you closer
          to your favorites. Stay connected and discover more!
        </p>
      </div>
      <!-- Quick Links -->
